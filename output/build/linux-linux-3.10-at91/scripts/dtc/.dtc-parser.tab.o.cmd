cmd_scripts/dtc/dtc-parser.tab.o := /usr/bin/gcc -Wp,-MD,scripts/dtc/.dtc-parser.tab.o.d     -Iscripts/dtc -Iscripts/dtc/libfdt -c -o scripts/dtc/dtc-parser.tab.o scripts/dtc/dtc-parser.tab.c
