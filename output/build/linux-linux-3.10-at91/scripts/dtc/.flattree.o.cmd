cmd_scripts/dtc/flattree.o := /usr/bin/gcc -Wp,-MD,scripts/dtc/.flattree.o.d     -Iscripts/dtc -Iscripts/dtc/libfdt -c -o scripts/dtc/flattree.o scripts/dtc/flattree.c
