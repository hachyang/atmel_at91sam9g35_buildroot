cmd_scripts/dtc/dtc-lexer.lex.o := /usr/bin/gcc -Wp,-MD,scripts/dtc/.dtc-lexer.lex.o.d     -Iscripts/dtc -Iscripts/dtc/libfdt -c -o scripts/dtc/dtc-lexer.lex.o scripts/dtc/dtc-lexer.lex.c
