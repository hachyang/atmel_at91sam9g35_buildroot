cmd_scripts/kconfig/zconf.tab.o := /usr/bin/gcc -Wp,-MD,scripts/kconfig/.zconf.tab.o.d    -DCURSES_LOC="<ncurses.h>" -DLOCALE  -Iscripts/kconfig -c -o scripts/kconfig/zconf.tab.o scripts/kconfig/zconf.tab.c
